...
The website remembers the address and reads the two scores, current player, two-minute turn countdown, and cart countdown from the Python app. The computers do not need internet access after the site dependencies are installed.
